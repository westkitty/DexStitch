import type { PatternResult, NestingOutput, EmbroideryProgram, Point2D } from "@dexstitch/types";
 ...
 */
function buildSVGPiece(piece: any, x: number, y: number, rotation: number, idx: number): string {
